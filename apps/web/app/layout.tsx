          ...
          <aside className="sidebar">
            ...
            <div className="sidebar-footer">
              ...
              <div className="creator-badge">
                <span>Built by <a href="https://github.com/jasirjru" target="_blank" rel="noopener noreferrer" className="creator-link">Jasir</a></span>
                <a href="https://github.com/jasirjru/NEXUS" target="_blank" rel="noopener noreferrer" className="github-chip" title="View Source on GitHub">
